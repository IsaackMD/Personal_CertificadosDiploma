...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2023 a las 22:48:54
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_usu2` (IN `usu_id` INT, IN `nom` VARCHAR(50), IN `apep` VARCHAR(50), IN `apem` VARCHAR(50), IN `correo` VARCHAR(50), IN `pass` VARCHAR(50), IN `tel` VARCHAR(50), IN `sex` VARCHAR(50), IN `rol` VARCHAR(50), IN `dni` INT)   begin
Update usuario
set usu_Nombre = nom, usu_Apellido_P = apep, usu_Apellido_M = apem,Correo =correo, Password = pass, Sexo = sex, Telefono = tel ,Rol_ID=rol, Estado = 1 , dni = dni where UsuarioID = usu_id;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `info_x_dni` (IN `Dni` INT)   begin
	select * from usuario WHERE Estado = 1 and dni=Dni;
end$$
...
insert into curso (CategoriaID,Titulo,Descripcion,Fecha_Ini,Fecha_Fin,Fecha_Registro,InstructorID,Estado,Curso_img)
Values (cat_id,tittle,descrip,fechini,fechfin,Now(),inst_id,1,'1.png');
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `listarCursos` ()   SELECT cu.CursoID,cu.Titulo,cu.Descripcion,cu.Fecha_Ini,cu.Fecha_Fin,cu.Curso_img,ca.CategoriaID,ca.Nombre,i.InstructorID,i.ins_Nombre,i.ins_Apellido_P,i.ins_Apellido_M, i.Correo,i.Telefono, CU.Fecha_Registro FROM curso cu INNER JOIN categoria ca on cu.CategoriaID = ca.CategoriaID INNER JOIN instructor i on cu.InstructorID = i.InstructorID and cu.Estado = 1 ORDER BY cu.CursoID DESC$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `Listar_Curso_x_curid` (IN `cur_id` INT)   BEGIN
SELECT 
			curso_usu.CursoDetalleID,
			curso.CursoID,
            curso.Titulo,
            curso.Descripcion,
            curso.Fecha_Ini,
            ...
            where curso_usu.CursoID = cur_id and curso_usu.Estado=1;          
            END$$
...
(2, 'Programación', '2023-10-02 11:15:00', 1),
...
CREATE TABLE `curso` (
  ...
  `Curso_img` varchar(250) DEFAULT NULL,
...
INSERT INTO `curso` (`CursoID`, `CategoriaID`, `Titulo`, `Descripcion`, `Fecha_Ini`, `Fecha_Fin`, `InstructorID`, `Curso_img`, `Fecha_Registro`, `Estado`) VALUES
(1, 4, 'Negocios 2', 'loeem', '2023-11-01', '2023-09-12', 1, '../../public/1.png', '2023-10-02 07:14:18', 1),
(2, 2, 'Curso De HTML5', 'Lorem Ipsum es simplemente el texto de relleno de ', '2023-11-02', '2023-12-29', 1, '../../public/443320695.png', '2023-10-02 07:15:01', 1),
(3, 2, 'Programación Orientada En Objetos', 'asasdd', '2023-11-08', '2023-10-13', 2, '../../public/137114934.png', '2023-10-02 07:15:01', 1),
(35, 3, 'Educación para niños 2', 'Lorem Ipsum es simplemente el texto de relleno de ', '2023-09-12', '2023-12-20', 1, '../../public/283354074.png', '2023-10-02 07:14:18', 1);
...
(93, 35, 5, '2023-12-07 11:25:10', 1),
(94, 35, 1, '2023-12-07 11:36:37', 1),
(95, 3, 1, '2023-12-07 11:36:42', 1),
(96, 2, 1, '2023-12-07 11:37:19', 1),
(97, 1, 1, '2023-12-07 11:37:48', 1);
...
INSERT INTO `usuario` (`UsuarioID`, `usu_Nombre`, `usu_Apellido_P`, `usu_Apellido_M`, `Correo`, `Telefono`, `Password`, `Sexo`, `Fecha_Registro`, `Estado`, `Rol_ID`, `dni`) VALUES
(1, 'Kevin Isaac', 'Sanchez', 'Benitez', 'sanchezk801@gmail.com', '1234567897', '123456789', 'H', '2023-10-01 21:38:15', 1, 1, 4445461),
(2, 'Juan', 'Pérez', 'García', 'juan@example.com', '7794246510', 'clave123', 'H', '2023-10-01 21:43:19', 1, 1, 4445462),
(3, '', 'test2', 'test', 'test', '1', 'test', '5', '2023-10-01 21:43:19', 0, 0, 4445463),
(4, 'Luis', 'Martínez', 'Rodríguez', 'luis@example.com', '5589401245', 'miclave', 'H', '2023-10-01 21:43:19', 1, 1, 12345678),
(5, 'Admin', 'Super Admin', 'Rodríguez', 'admin@example.com', '4564824012', 'admin', 'H', '2023-10-01 21:43:19', 1, 2, 4445465),
(6, 'Mariasss', 'Perez', 'Martinez', 'maria@example.com', '7787972871', 'pypypy', 'M', '2023-10-01 21:43:19', 0, 1, 4445466),
(7, 'a', 'test', 'test', 'test', '7787972', 'test', 'M', '2023-11-16 23:38:13', 0, 1, 4445467),
(9, 'asdd', 'sddsa', 'saddsa', 'sdad', '6545646', 'ssdd', 'H', '2023-11-17 16:05:36', 0, 1, 4445468),
(12, 'Test', 'test1', 'test2', 'test3', '77878', 'test4', 'H', '2023-11-20 13:59:50', 0, 2, 4445469);
...
--
ALTER TABLE `curso_usu`
  MODIFY `CursoDetalleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
