                ...
                <input type="hidden" name="InstructorID" id="InstructorID"/>
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control tx-uppercase" id="ins_Apellido_P" type="text" name="ins_Apellido_P" required/>
                        </div>
                        <div class="form-group">
                            <label class="form-control-label">Apellido Materno: <span class="tx-danger">*</span></label>
                            <input class="form-control tx-uppercase" id="ins_Apellido_M" type="text" name="ins_Apellido_M" required/>
                        </div>
                        <div class="form-group">
