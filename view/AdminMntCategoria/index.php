...
<html lang="es">
  ...
  <?php require_once('../../view/html/MainHead.php') ?>
    ...
    <title>Big-Smoke: MntCategoria</title>
  </head>
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        ...
        <h4 class="tx-gray-800 mg-b-5">Categoria</h6>
        <p class="mg-b-0">Listadod de Categorias</p>

        <button  class="btn btn-outline-primary m-2" id ="add_button" onclick = "nuevo()" ><i class="fa fa-plus-square">Nueva Categoria</i></button>
